  ...
  return (
    <SectionWrapper id="contact" hasBackgroundPattern>
      <div className="text-center mb-12">
        <h2 className="text-3xl md:text-4xl font-bold text-foreground font-headline">Hubungi Saya</h2>
        <p className="text-lg text-muted-foreground mt-2 max-w-xl mx-auto">
          Punya proyek atau hanya ingin menyapa? Jangan ragu untuk menghubungi.
        </p>
      </div>
      <div className="grid md:grid-cols-2 gap-10 md:gap-16 max-w-5xl mx-auto items-start">
        <div className="space-y-6 p-6 md:p-8 bg-card rounded-xl shadow-xl border border-border/60">
            <h3 className="text-2xl font-semibold text-primary mb-6 font-headline">Informasi Kontak</h3>
            ...
            {siteConfig.socials && siteConfig.socials.length > 0 && (
                <div className="mt-8 pt-6 border-t border-border/60">
                    <h4 className="text-lg font-semibold text-primary mb-3">Ikuti Saya</h4>
